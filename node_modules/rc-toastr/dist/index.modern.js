import React__default, { createContext, useContext, createElement, useLayoutEffect, useEffect, useState, useRef, useCallback, useMemo, forwardRef, Fragment } from 'react';
...
function createMotionComponent(_a) {
    ...
    function MotionComponent(props, externalRef) {
         ...
         */
        return (createElement(VisualElementHandler, { visualElement: context.visualElement, props: __assign(__assign({}, config), props) },
            features,
...
function makeLatestValues(props, context, presenceContext, scrapeMotionValues) {
    ...
    if (variantToSet &&
        ...
        list.forEach(function (definition) {
            ...
            if (!resolved)
                return;
            var transitionEnd = resolved.transitionEnd; var target = __rest(resolved, ["transitionEnd", "transition"]);
...
function setTarget(visualElement, definition) {
    ...
    var _a = resolved ? visualElement.makeTargetAnimatable(resolved, false) : {}, _b = _a.transitionEnd, transitionEnd = _b === void 0 ? {} : _b; var target = __rest(_a, ["transitionEnd", "transition"]);
...
var styles = {"container":"_3o6gs","inner":"_1gjw2"};
...
var Toast = function Toast(_ref) {
  ...
  var _useToast = useToast(),
      config = _useToast.config,
      toasts = _useToast.toasts,
      close = _useToast.close;
  ...
  var isLastToast = toasts[toasts.length - 1].id === toast.id;
  var allNextToasts = toasts.filter(function (t) {
    return t.id !== toasts[toasts.length - 1].id;
  });
  var allPreviousToasts = allNextToasts.filter(function (t) {
    return t.id >= toast.id;
  });
  var prevToast = toasts.find(function (t) {
    var curr = toasts.indexOf(toast);
    var prev = allNextToasts[curr - 1];
    return t.id === (prev === null || prev === void 0 ? void 0 : prev.id);
  });
  var prevToastRef = useRef(null);
  var hidden = Boolean(!opened && !isLastToast);
  var mx = allPreviousToasts.length * 20;
  var css = {
    toast: {
  ...
  return createElement(motion.div, {
    ...
    ref: (prevToast === null || prevToast === void 0 ? void 0 : prevToast.id) !== toast.id ? prevToastRef : null,
    key: toast.id,
    layout: true,
    initial: {
      opacity: 0,
      x: config.position.includes('left') ? -100 : config.position.includes('right') ? 100 : 0,
      y: 0
    },
    animate: {
      opacity: 1,
    ...
    style: {
      borderRadius: hidden ? config.position.includes('top') ? "0 0 20px 20px" : "20px 20px 0 0" : "0.375rem",
      overflow: 'hidden',
    ...
    onClick: function onClick() {
      return toasts.length > 1 && setOpened(function (opened) {
        return !opened;
      });
    }
  }, config.renderAs({
...
function ToastContainer() {
  ...
  var _React$useState = useState(false),
      toastOpened = _React$useState[0],
      setToastOpened = _React$useState[1];

  var LeftPositionContainer = {
    left: 0,
    right: 'auto'
  };
  var RightPositionContainer = {
    left: 'auto',
    right: 0
  };
  return createElement(Fragment, null, toasts.length ? createElement(motion.div, {
    layout: true,
    ...
    style: _extends({
      ...
      zIndex: (_config$zIndex = config.zIndex) != null ? _config$zIndex : 100,
      flexDirection: config.position.includes('top') ? 'column-reverse' : 'column'
    }, config.position.includes('left') || config.position.includes('right') ? (config.position.includes('left') && LeftPositionContainer, config.position.includes('right') && RightPositionContainer) : {
      left: 0,
      right: 0
    })
...
var styles$2 = {"content":"_1PJpC","progress_bar":"_2RnOX","message":"_3lJ0n","close_button":"_1Of5w","icon":"_WfpkX"};
...
var ToastContent = function ToastContent(_ref) {
  ...
  }, visible ? createElement(Fragment, null, createElement("div", {
    className: styles$2.content
  }, createElement("div", {
    className: styles$2.icon
  }, createElement(ToastIcon, {
    type: toast.type
  })), createElement("p", {
    className: styles$2.message,
    onClick: onClick
  }, toast.message)), createElement("button", {
    onClick: function onClick() {
      return close(toast.id);
    },
    className: styles$2.close_button
  }, createElement("svg", {
  ...
  }))), showProgressBar && createElement("div", {
    style: {
      width: progress + '%',
      backgroundColor: darken(config.toastBackgroundColor(toast.type), -20)
    },
    className: styles$2.progress_bar
  })) : null);
};
...
function Loading() {
  return React__default.createElement(motion.svg, {
    animate: {
      rotate: 360
    },
    transition: {
...
var theme = {
  ...
  icons: {
    error: React__default.createElement(Error$1, null),
    info: React__default.createElement(Info, null),
    success: React__default.createElement(Success, null),
    warning: React__default.createElement(Warning, null),
    "default": React__default.createElement(Default, null),
    loading: React__default.createElement(Loading, null)
  }
};
...
var ToastProvider = function ToastProvider(_ref) {
  var _config$position, _config$autoClose, _config$duration, _config$maxToasts, _config$pauseOnHover, _config$showProgressB, _config$zIndex, _config$renderToastIc, _config$toastBackgrou, _config$renderAs;

  var children = _ref.children,
      _config = _ref.config;
  var DEFAULT_TOAST_CONFIG = {
    position: (_config$position = _config === null || _config === void 0 ? void 0 : _config.position) != null ? _config$position : 'top',
    autoClose: (_config$autoClose = _config === null || _config === void 0 ? void 0 : _config.autoClose) != null ? _config$autoClose : true,
    duration: (_config$duration = _config === null || _config === void 0 ? void 0 : _config.duration) != null ? _config$duration : 5000,
    maxToasts: (_config$maxToasts = _config === null || _config === void 0 ? void 0 : _config.maxToasts) != null ? _config$maxToasts : 3,
    pauseOnHover: (_config$pauseOnHover = _config === null || _config === void 0 ? void 0 : _config.pauseOnHover) != null ? _config$pauseOnHover : true,
    showProgressBar: (_config$showProgressB = _config === null || _config === void 0 ? void 0 : _config.showProgressBar) != null ? _config$showProgressB : true,
    zIndex: (_config$zIndex = _config === null || _config === void 0 ? void 0 : _config.zIndex) != null ? _config$zIndex : 30,
    renderToastIcon: (_config$renderToastIc = _config === null || _config === void 0 ? void 0 : _config.renderToastIcon) != null ? _config$renderToastIc : function (type) {
      return theme.icons[type];
    },
    toastBackgroundColor: (_config$toastBackgrou = _config === null || _config === void 0 ? void 0 : _config.toastBackgroundColor) != null ? _config$toastBackgrou : function (type) {
      return theme.colors[type];
    },
    renderAs: (_config$renderAs = _config === null || _config === void 0 ? void 0 : _config.renderAs) != null ? _config$renderAs : function (props) {
      return createElement(ToastContent, Object.assign({}, props));
    }
  };
  ...
  var _React$useState2 = useState(DEFAULT_TOAST_CONFIG),
      config = _React$useState2[0],
      updateConfig = _React$useState2[1];
  ...
  var toast = function toast(message, variant) {
    var id = toasts.length > 0 ? toasts[toasts.length - 1].id + 1 : 1;
    setToasts(function () {
      return [].concat(toasts, [{
        id: id,
        createdAt: new Date(),
        message: message,
        type: variant != null ? variant : 'default'
      }]);
    });
    return id;
  };
  ...
  toast["default"] = function (message) {
    return toast(message, 'default');
  };

  toast.loading = function (promise, _ref2) {
  ...
  var close = function close(id) {
    setToasts(toasts.filter(function (toast) {
      return toast.id !== id;
    }));
  };
  ...
  }, createElement(ToastContainer, null), children);
};

export { ToastProvider, theme, useToast };
